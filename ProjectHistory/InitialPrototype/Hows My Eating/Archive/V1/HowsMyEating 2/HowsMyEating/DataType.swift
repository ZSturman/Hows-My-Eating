...
struct MotionData: Codable {
    ...
    init(timestamp: Double, attitude: Attitude, rotationRate: RotationRate, userAcceleration: UserAcceleration, gravity: Gravity, transformedRotation: TransformedRotation) {
        self.timestamp = timestamp
...
var defaultMotionData = MotionData(timestamp: 0.0, attitude: .zero, rotationRate: .zero, userAcceleration: .zero, gravity: .zero, transformedRotation: .zero)
